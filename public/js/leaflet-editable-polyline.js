    ...
    _addMethods: function() {
        ...
        this._parseOptions = function(options) {
            ...
            if(!options.pointIcon)
                this._options.pointIcon = L.icon({ iconUrl: 'images/polyline-edit-marker.png', iconSize: [11, 11], iconAnchor: [6, 6] });
            if(!options.newPointIcon)
                this._options.newPointIcon = L.icon({ iconUrl: 'images/polyline-edit-marker2.png', iconSize: [11, 11], iconAnchor: [6, 6] });
        };
